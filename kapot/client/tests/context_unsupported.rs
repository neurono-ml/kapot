...
mod unsupported {
    ...
    async fn should_execute_explain_query_correctly(
        ...
        let expected = vec![
            ...
            "|               |           CoalesceBatchesExec: target_batch_size=8192                                                                                                                                                                                                                                            |",
            "|               |             FilterExec: id@0 > 4                                                                                                                                                                                                                                                                 |",
            "|               |               ParquetExec: file_groups={1 group: [[Users/kapot/git/arrow-kapot/kapot/client/testdata/alltypes_plain.parquet]]}, projection=[id], predicate=id@0 > 4, pruning_predicate=CASE WHEN id_null_count@1 = id_row_count@2 THEN false ELSE id_max@0 > 4 END, required_guarantees=[] |",
            "|               |                                                                                                                                                                                                                                                                                                  |",
            "+---------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+",        
        ];
