...
#[derive(Debug)]
pub struct KapotFunctionRegistry {
    pub scalar_functions: HashMap<String, Arc<ScalarUDF>>,
    pub aggregate_functions: HashMap<String, Arc<AggregateUDF>>,
    pub window_functions: HashMap<String, Arc<WindowUDF>>,
}

impl Default for KapotFunctionRegistry {
    fn default() -> Self {
...
impl FunctionRegistry for KapotFunctionRegistry {
...
impl From<&SessionState> for KapotFunctionRegistry {
