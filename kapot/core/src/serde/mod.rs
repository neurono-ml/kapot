...
impl Default for KapotCodec {
    fn default() -> Self {
        Self {
            ...
            physical_extension_codec: Arc::new(KapotPhysicalExtensionCodec::default()),
...
impl Default for KapotPhysicalExtensionCodec {
    fn default() -> Self {
        Self {
...
mod test {
    ...
    async fn file_format_serialization_roundtrip() {
        ...
        let codec = crate::serde::KapotLogicalExtensionCodec::default();
        let plan_message =
    ...
    async fn test_unresolved_shuffle_exec_roundtrip() {
        ...
        let codec = KapotPhysicalExtensionCodec::default();
        let mut buf: Vec<u8> = vec![];
        codec
