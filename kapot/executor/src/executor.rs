...
use kapot_core::RuntimeProducer;
use dashmap::DashMap;
...
pub struct Executor {
    ...
    /// Function registry
    pub function_registry: Arc<KapotFunctionRegistry>,
...
impl Executor {
    ...
    pub fn new_basic(
        ...
        Self::new(
            ...
            runtime_producer,
            config_producer,
            Arc::new(KapotFunctionRegistry::default()),
    ...
    pub fn new(
        ...
        runtime_producer: RuntimeProducer,
        config_producer: ConfigProducer,
        function_registry: Arc<KapotFunctionRegistry>,
